...
public class Generic02 {
    public static void main(String[] args) {
        ...
        //3. 重点：在遍历的时候，可以直接取出 Dog 类型而不是 Object
        //4. public class ArrayList<E> {} E称为泛型,那么 Dog->E
        ArrayList<Dog02> arrayList = new ArrayList<Dog02>();
        arrayList.add(new Dog02("旺财", 10));
        arrayList.add(new Dog02("发财", 1));
        arrayList.add(new Dog02("小黄", 5));
        //假如我们的程序员，不小心，添加了一只猫
        //arrayList.add(new Cat("招财猫", 8));
        System.out.println("===使用泛型====");
        for (Dog02 dog02 : arrayList) {
            System.out.println(dog02.getName() + "-" + dog02.getAge());
        }
